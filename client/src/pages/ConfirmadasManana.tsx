...
export default function ConfirmadasManana() {
    ...
    <DashboardLayout>
      <div className="p-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Confirmadas Mañana</h1>
            <p className="text-gray-400">Pacientes que confirmaron presencia para mañana</p>
          </div>
          <Button
            variant="outline"
            onClick={() => setLocation("/")}
          ...
          <table className="w-full">
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={5} className="text-center p-8 text-gray-400">
                    No hay citas confirmadas para mañana
                  </td>
                </tr>
              ) : (
