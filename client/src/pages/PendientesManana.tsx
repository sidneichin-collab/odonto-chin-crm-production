...
export default function PendientesManana() {
    ...
    <DashboardLayout>
      <div className="p-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Pendientes Mañana</h1>
            <p className="text-gray-400">Consultas pendientes de confirmación para mañana</p>
          </div>
          <Button
            variant="outline"
            onClick={() => setLocation("/")}
