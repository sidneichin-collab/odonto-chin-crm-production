...
export default function CanceladasManana() {
    ...
    <DashboardLayout>
      <div className="p-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Canceladas Mañana</h1>
            <p className="text-gray-400">Consultas canceladas para mañana</p>
          </div>
          <Button
            variant="outline"
            onClick={() => setLocation("/")}
          ...
          <table className="w-full">
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={5} className="text-center p-8 text-gray-400">
                    No hay citas canceladas para mañana
                  </td>
                </tr>
              ) : (
